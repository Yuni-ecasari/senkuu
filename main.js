...
async function start(){
  ...
  console.log(color(figlet.textSync('Felix - MD', {font: 'Standard',horizontalLayout: 'default',vertivalLayout: 'default',width: 80,whitespaceBreak: false }), 'red'))
  console.log(color('------------------------------------------------------------------------', 'white'))
  ...
  const conn = Baileys({
    printQRInTerminal: true,
		auth: state,
		browser: [config.namebot, "Felix - MD", "1.0.0"],
